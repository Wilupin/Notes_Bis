function [h_fig, h_a, h_b] = make_2_axes3()
...
set(h_fig,'PaperSize',[width_1 height_1_2+0.8]);
set(h_fig,'PaperPositionMode','manual');
set(h_fig,'PaperPosition',[0 0 width_1 height_1_2+0.8]);
...
h_a = axes('Units','normalized',...
    ...
    'FontName', f_name);
dim = [0.2 0.2 0.3 0.3];
h_ann_a = annotation('textbox',dim,'String','(c)','FitBoxToText','on', 'Color', 'white');
...
h_b = axes('Units','normalized',...
     ...
     'FontSize', fsz,...
     'FontName', f_name);
 h_ann_b = annotation('textbox',dim,'String','(d)','FitBoxToText','on', 'Color', 'white');
